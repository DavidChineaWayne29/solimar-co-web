...
export const siteConfig: SiteConfig = {
  ...
  theme: {
    ...
    fonts: {
      ...
      body:       'Lato',
      displayUrl: 'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&display=swap',
    ...
    items: [
      {
        ...
        description: 'Trabajamos con agricultores y pescadores de la isla para garantizar la máxima frescura.',
      },
      {
        icon:        'ChefHat',
        title:       'Recetas de siempre',
        description: 'Papas arrugadas, mojo, ropa vieja... preparadas como las hacían nuestras abuelas.',
      },
      {
        icon:        'Wine',
        title:       'Vinos canarios',
        description: 'Selección exclusiva de vinos DO Tacoronte-Acentejo y Valle de la Orotava.',
      },
      {
        icon:        'Users',
        title:       'Para todos',
        description: 'Grupos, familias, celebraciones y eventos privados. Llámanos y lo preparamos.',
      },
    ],
  },
  ...
  gallery: {
    ...
    images: [
      { src: '/images/gallery-1.jpg', alt: 'Papas arrugadas con mojo' },
      { src: '/images/gallery-2.jpg', alt: 'Ropa vieja canaria' },
      { src: '/images/gallery-3.jpg', alt: 'Terraza del restaurante' },
      { src: '/images/gallery-4.jpg', alt: 'Pescado fresco del día' },
      { src: '/images/gallery-5.jpg', alt: 'Postres caseros' },
      { src: '/images/gallery-6.jpg', alt: 'Ambiente interior' },
    ],
  },
    ...
    items: [
      {
        ...
        description: 'Papas canarias cocidas en sal gorda con mojo rojo y verde de la casa',
        price:       '6,50 €',
      },
      {
        category:    'Entrantes',
        name:        'Queso asado con miel de palma',
        description: 'Queso de cabra local asado a la plancha con miel de palma de La Gomera',
        price:       '9,00 €',
      },
      {
        category:    'Principales',
        name:        'Ropa vieja canaria',
        description: 'Garbanzos, pollo y chorizo en salsa con pimientos y tomate',
        price:       '13,50 €',
      },
      {
        category:    'Principales',
      ...
      },
      {
        ...
        description: 'Receta tradicional canaria marinada en vinagre, ajo y pimentón',
        price:       '15,00 €',
      },
      {
        category:    'Postres',
